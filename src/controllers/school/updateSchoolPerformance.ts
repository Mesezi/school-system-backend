...
export const updateSchoolPerformance = asyncHandler(async (req:any, res:any) => {
  ...
  try {
    ...
    school.schoolResultDetails.performance = updateData;
    await school.save();
  
    res.status(200).json({
      success: true,
      message: 'Updated school performance',
    });
  } catch (error) {
